...
export const metadata: Metadata = {
  title: "Cabang Teh Daun | Temukan Lokasi Kami",
  description:
    "Kunjungi cabang Teh Daun terdekat di berbagai kota seperti Surabaya, Jakarta, Bandung, dan lainnya. Nikmati kesegaran teh alami di lokasi kami.",
  keywords: [
    "Cabang Teh Daun",
    "Lokasi Teh Daun",
    "Teh Daun Surabaya",
  ...
  openGraph: {
    title: "Cabang Teh Daun | Temukan Lokasi Kami",
    description:
      "Cari tahu lokasi cabang Teh Daun di seluruh Indonesia. Nikmati minuman teh alami di kota Anda.",
  ...
  twitter: {
    ...
    title: "Cabang Teh Daun | Temukan Lokasi Kami",
    description:
      "Temukan cabang Teh Daun terdekat dan nikmati kesegaran alami teh berkualitas tinggi.",
